...
class SuburbsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suburb" do
    assert_difference('Suburb.count') do
      post suburbs_url, params: { suburb: { DisplayName: @suburb.DisplayName, Postcode: @suburb.Postcode, State: @suburb.State, Suburb: @suburb.Suburb } }
    end
  ...
  test "should update suburb" do
    patch suburb_url(@suburb), params: { suburb: { DisplayName: @suburb.DisplayName, Postcode: @suburb.Postcode, State: @suburb.State, Suburb: @suburb.Suburb } }
