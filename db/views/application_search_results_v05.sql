SELECT a.id,
       ...
       a.lot_number,
       a.street_name,
       CONCAT(if(a.lot_number is null, '', concat(a.lot_number, ' ')), if(a.street_number is null, '', concat(a.street_number, ' ')), a.street_name) as location,
...
left join clients as contact on a.contact_id = contact.id
