  ...
  def change
    ...
    reversible do |dir|
      dir.up do
        ...
        ApplicationType.find_by(application_type: 'SC').update!(display_priority: 4)
        ApplicationType.find_by(application_type: 'RC').update!(display_priority: 5)
        ApplicationType.find_by(application_type: 'LG').update!(display_priority: 6)
      end
    end
  end
end
